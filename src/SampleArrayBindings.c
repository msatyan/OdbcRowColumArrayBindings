...
int main (long argc, char* argv[])
{
    ...
    int             AllTestScenarioStatus = 0;
    int             TestID=0;


    if( argc == 1 )
    {
        char *MyLocalConnStr = "DRIVER={IBM INFORMIX ODBC DRIVER};SERVER=ids5;DATABASE=db1;HOST=x.x.x.x;PROTOCOL=onsoctcp;SERVICE=5555;UID=user1;PWD=xyz;";
